...
genedata <- split(genedata,genedata$V5)
...
#calculate corrected nascent UMI for each genes (corrected Label=theta*total)
...
#compute detection rate alpha/cell
...
#compute corrected nascent UMI per gene per cell
